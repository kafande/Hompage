#!r6rs ;; Copyright notices may be found in "%3a125/hashtables.sls"
...
(library (srfi srfi-125)
  (export make-hash-table hash-table hash-table-unfold
   ...
   (rename (hash deprecated:hash) (string-hash deprecated:string-hash)
  ...
  (import
    ...
    (rename (srfi :126) (hashtable-merge! hash-table-merge!)
